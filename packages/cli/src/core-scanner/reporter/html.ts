...
<head>
  ...
  <title>W.H.Agent Security Report — Grade ${report.score.grade}</title>
...
<body>
  <div class="container">
    ...
    <header class="header">
      <div class="header-content">
        ...
        <div class="header-info">
          <h1 class="title">W.H.Agent Security Report</h1>
    ...
    <!-- Footer -->
    <footer class="footer">
      <p>Generated by <strong>W.H.Agent</strong> &mdash; Security auditor for AI agent configurations</p>
