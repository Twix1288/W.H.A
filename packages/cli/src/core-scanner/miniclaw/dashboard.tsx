 ...
 * The wh-agent package itself does NOT include React — this component
 ...
 *
 * Usage:
 *   import { MiniClawDashboard } from '@wh-agent/miniclaw/dashboard';
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.footer}>
        ...
        <span>MiniClaw by W.H.Agent</span>
      </div>
    </div>
  );
}
