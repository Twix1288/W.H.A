...
This file documents the MiniClaw runtime specifically. Scanner report JSON and package-surface notes for W.H.Agent live in the repo-level [`README.md`](../../README.md) and [`API.md`](../../API.md).
...
It is not currently exported as a separate npm subpath such as `ecc-wh-agent/miniclaw/dashboard`.
