		...
		input_schema: {
			...
			properties: {
				attack_name: {
					...
					description: "Short name for the attack",
				},
				attack_chain: {
					type: "array" as const,
				...
				entry_point: {
					type: "string" as const,
					description: "File and line where attack enters",
				},
				impact: {
					type: "string" as const,
					enum: [
				...
				cvss_estimate: {
					...
					description: "Estimated CVSS 3.1 score (0-10)",
				},
				evidence: {
					type: "string" as const,
					description: "Specific config content that enables this attack",
				},
				prerequisites: {
					type: "string" as const,
					description: "What the attacker needs before exploiting",
				},
			},
			required: [
				"attack_name",
...
export const DEFENDER_TOOLS = [
	{
		...
		input_schema: {
			...
			properties: {
				gap_name: {
					type: "string" as const,
					description: "Short name for the defense gap",
				},
				current_state: {
					type: "string" as const,
					description: "What the config currently does (or doesn't do)",
				},
				recommended_fix: {
					type: "string" as const,
					description: "Exact config change needed",
				},
				fix_type: {
					type: "string" as const,
					enum: [
	...
	},
	{
		...
		input_schema: {
			...
			properties: {
				practice_name: {
					type: "string" as const,
					description: "Name of the good practice",
				},
				description: {
					type: "string" as const,
