...
export const INJECTION_PAYLOADS: ReadonlyArray<InjectionPayload> = [
	...
	},
	{
		...
		severity: "critical",
		source:
			"AIM jailbreak — fictional framing technique, documented in jailbreak databases",
	},
	...
	},
	{
		...
		severity: "high",
		source:
			"Multi-language extraction technique — academic papers on LLM security",
	},
	{
		id: "extract-004",
		category: "system_prompt_extraction",
...

	{
		...
		severity: "medium",
		source:
			"CRESCENDO attack — Microsoft Research, multi-turn jailbreak technique",
	},
	{
		id: "crescendo-002",
		category: "crescendo",
	...
	},
	{
		...
		severity: "high",
		source:
			"Zero-width character injection — documented in Unicode security review",
	},
	{
		id: "unicode-003",
		category: "unicode_homoglyph",
		...
		severity: "high",
		source:
			"Unicode bidirectional text attack — CVE pattern for text-display exploits",
	},
	{
		id: "unicode-004",
		category: "unicode_homoglyph",
	...
	},
	{
		...
		severity: "critical",
		source:
			"Markdown image exfiltration — documented in ChatGPT plugin attacks",
	},
	{
		id: "markdown-003",
		category: "markdown_injection",
		...
		severity: "medium",
		source:
			"Markdown link title injection — hidden instruction in title attribute",
	},
	{
		id: "markdown-004",
		category: "markdown_injection",
...

	{
		...
		severity: "high",
		source:
			"Indirect prompt injection — Greshake et al. 2023, data-plane attacks",
	},
	{
		id: "indirect-002",
		category: "indirect_injection",
		...
		severity: "high",
		source:
			"Code comment injection — indirect injection via code review requests",
	},
	{
		id: "indirect-003",
		category: "indirect_injection",
	...
	},
	{
		...
		severity: "critical",
		source:
			"Indirect injection via web content — Greshake et al. 2023, retrieval-augmented attacks",
	},
	...
	},
	{
		...
		severity: "high",
		source:
			"Multi-language bypass — Arabic instruction injection with RTL complexity",
	},
	{
		id: "multilang-003",
		category: "multi_language",
...

	{
		...
		severity: "critical",
		source:
			"Delimiter injection — role boundary confusion, documented in prompt injection taxonomy",
	},
	{
		id: "delimiter-002",
		category: "delimiter_confusion",
	...
	},
	{
		...
		severity: "high",
		source:
			"YAML front matter injection — structured config injection technique",
	},
...

	{
		...
		severity: "high",
		source:
			"Emotional manipulation — urgency exploitation, documented in social engineering taxonomy",
	},
	{
		id: "emotional-002",
		category: "emotional_manipulation",
	...
	},
	{
		...
		severity: "high",
		source:
			"Completion attack — exploiting language model autoregressive nature",
	},
	{
		id: "indirect-005",
		category: "indirect_injection",
		...
		severity: "critical",
		source:
			"Tool output poisoning — indirect injection via retrieval augmentation",
	},
	{
		id: "hierarchy-005",
		category: "instruction_hierarchy",
	...
	},
	{
		...
		severity: "high",
		source:
			"Constitutional AI reinterpretation attack — self-defeating argument",
	},
	{
		id: "roleplay-006",
		category: "roleplay_jailbreak",
	...
	},
	{
		...
		severity: "critical",
		source:
			"Document attachment injection — PDF/email workflow poisoning in agent security research",
	},
	{
		id: "indirect-008",
		category: "indirect_injection",
		...
		severity: "critical",
		source:
			"Link preview exfiltration — messaging platform crawler attack pattern",
	},
	{
		id: "indirect-009",
		category: "indirect_injection",
		...
		severity: "critical",
		source:
			"Persistent prompt injection / memory poisoning — multi-session agent compromise pattern",
	},
	{
		id: "indirect-010",
		category: "indirect_injection",
		...
		severity: "high",
		source:
			"Calendar invite prompt injection — browser and scheduling workflow hijack",
	},
	{
		id: "indirect-011",
		category: "indirect_injection",
		...
		severity: "critical",
		source:
			"Tool response poisoning — MCP/tool output prompt injection research",
	},
];
