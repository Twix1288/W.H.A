...
// Finding fingerprints — used by baseline diffing to identify "the same" finding
// across runs. (The golden-snapshot / tool-integrity hash lives in parser.ts as
// `astFingerprint`: a real structural AST hash, not a raw-text hash.)
