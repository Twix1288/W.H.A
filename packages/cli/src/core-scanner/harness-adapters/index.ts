...
const ADAPTERS: ReadonlyArray<HarnessAdapterDefinition> = [
	{
		...
		name: "Claude Code",
		description:
			"Claude Code project rules, permissions, MCP, hooks, agents, skills, and command surfaces.",
		configPaths: [
			"CLAUDE.md",
			".claude/CLAUDE.md",
			"settings.json",
	...
	},
	{
		...
		name: "OpenCode",
		description:
			"OpenCode agent, command, provider, plugin, and project configuration surfaces.",
		configPaths: [
			"opencode.json",
			"opencode.jsonc",
			".opencode.json",
	...
	},
	{
		...
		name: "Codex",
		description:
			"Codex AGENTS instructions, project config, prompts, and local memory/tooling surfaces.",
		configPaths: [
			"AGENTS.md",
			".codex/config.toml",
			".codex/agents",
	...
	},
	{
		...
		name: "Gemini CLI",
		description:
			"Gemini project instructions, commands, extensions, and MCP configuration surfaces.",
		configPaths: [
			"GEMINI.md",
	...
	},
	{
		...
		name: "Zed",
		description:
			"Zed project agent settings, MCP context servers, tool permissions, tasks, and external-agent handoff surfaces.",
	...
	},
	{
		...
		name: "VS Code",
		description:
			"VS Code workspace settings, tasks, extension recommendations, and editor-launched automation surfaces.",
		configPaths: [
	...
	},
	{
		...
		name: "dmux",
		description:
			"dmux multi-agent pane, worktree, launch, and lifecycle hook surfaces.",
		configPaths: [
			"dmux.yaml",
			"dmux.yml",
			"dmux.json",
	...
	},
	{
		...
		description:
			"Terminal-agent launch scripts, command wrappers, and shell-based orchestration surfaces.",
		configPaths: [
			"agent.yaml",
			"agent.yml",
			".agents",
	...
	},
	{
		...
		description:
			"Repository-local skills, commands, rules, prompts, and reusable agent templates.",
		configPaths: [
			"skills",
			"commands",
			"rules",
...
export function detectHarnessAdapters(rootPath: string): HarnessAdapterSummary {
	const detections = ADAPTERS.map((adapter) =>
		detectAdapter(rootPath, adapter),
	);
